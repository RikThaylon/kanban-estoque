  ...
  <svg className="reference-map" viewBox="0 0 620 320" role="img" aria-label="Fluxo industrial conectado">
    <defs>
      <linearGradient id="pathRed" x1="0" x2="1" y1="0" y2="0">
        <stop offset="0%" stopColor="#eeb1b2" />
        <stop offset="100%" stopColor="#f7d8d8" stopOpacity="0.28" />
      </linearGradient>
      <linearGradient id="pathGreen" x1="0" x2="1" y1="0" y2="0">
        <stop offset="0%" stopColor="#c3eee2" />
        <stop offset="100%" stopColor="#8ecfbf" stopOpacity="0.44" />
      </linearGradient>
      <filter id="softShadow" x="-20%" y="-20%" width="140%" height="150%">
        <feDropShadow dx="0" dy="9" floodColor="#5b6e68" floodOpacity="0.15" stdDeviation="8" />
      </filter>
    </defs>
    ...
    <g filter="url(#softShadow)" stroke="#303737" strokeLinejoin="round" strokeWidth="1.8">
      <g transform="translate(42 172)">
        <path d="M0 74 L0 34 L14 34 L14 48 L42 33 L42 48 L70 33 L70 74 Z" fill="#eda0a0" />
        <path d="M-4 74 H78" fill="none" />
        <path d="M9 25 H24 V34 H9 Z" fill="#f6c7c5" />
        <path d="M18 25 V2 H28 V25" fill="#d9eee6" />
      ...
      <g transform="translate(225 218)">
        <path d="M0 28 L46 0 L94 27 L47 56 Z" fill="#f4b9b7" />
        <path d="M0 28 V81 L47 109 V56 Z" fill="#edaaa8" />
        <path d="M47 56 L94 27 V80 L47 109 Z" fill="#c9eadf" />
        <path d="M17 54 L34 64 V84 L17 75 Z" fill="#f9eeee" />
        <path d="M60 59 H82 V80 H60 Z" fill="#f9eeee" />
      </g>

      <g transform="translate(351 94)">
        <path d="M0 30 L51 0 L101 28 L50 58 Z" fill="#c9eadf" />
        <path d="M0 30 V84 L50 113 V58 Z" fill="#eaa09f" />
        <path d="M50 58 L101 28 V82 L50 113 Z" fill="#c9eadf" />
        <path d="M18 54 H40 V88 H18 Z" fill="#f7efee" />
        <path d="M74 58 L86 66 V86 L74 78 Z" fill="#f7efee" />
      </g>

      <g transform="translate(182 151)">
        <path d="M0 33 L34 14 L70 35 L35 56 Z" fill="#f0aaa8" />
        <path d="M0 33 V65 L35 86 V56 Z" fill="#e8918e" />
        <path d="M35 56 L70 35 V67 L35 86 Z" fill="#c8e8df" />
        <path d="M70 45 H94 L110 61 V79 H70 Z" fill="#c8e8df" />
        <path d="M94 45 V61 H110" fill="#f7efee" />
        <circle cx="82" cy="82" r="8" fill="#f8f4f2" />
        <circle cx="109" cy="82" r="8" fill="#f8f4f2" />
      </g>

      <g transform="translate(465 222)">
        <path d="M0 49 L52 21 L104 52 L52 82 Z" fill="#e99c9a" />
        <path d="M0 49 V69 L52 99 V82 Z" fill="#e7a6a2" />
        <path d="M52 82 L104 52 V72 L52 99 Z" fill="#c8e8df" />
        <path d="M22 48 L52 31 L83 50 L52 67 Z" fill="#f8f0ee" />
        <path d="M32 49 L48 59 M44 43 L60 53 M56 37 L72 47" opacity="0.48" />
        <path d="M23 21 L74 51 V7 L23 -23 Z" fill="#c8e8df" />
        <path d="M31 3 L43 21 L58 15" fill="none" />
      </g>
    </g>

    <path d="M421 172 L431 164 L431 189 L421 197 Z" fill="#f7efee" stroke="#303737" strokeLinejoin="round" strokeWidth="1.5" />
    <path d="M431 164 L448 174 L448 199 L431 189 Z" fill="#d75b5f" stroke="#303737" strokeLinejoin="round" strokeWidth="1.5" />
      ...
      <main className="reference-stage">
        <section className="reference-copy-block">
          ...
          <h1 className="reference-title font-display font-black text-steel-900">
            <span>Controle industrial com visão</span>
        ...
        <aside className="reference-login">
          <div className="reference-panel liquid-glass">
            <div className="reference-brand">
              <div className="reference-logo">K</div>
              <div className="min-w-0">
                <h2 className="font-display text-2xl font-black text-steel-900">Kanban Estoque</h2>
              ...
              <div>
                ...
                <div className="reference-field relative">
                  ...
                  <input
                    ...
                    className="block w-full rounded-md border border-white/70 bg-white/75 py-1.5 pl-9 pr-3 text-sm text-navy-900 placeholder:text-navy-300 focus:border-steel-900/70 focus:ring-2 focus:ring-steel-900/20"
                    placeholder="usuário"
                    required
